...
export function TokenLaunchpad() {
    ...
    async function createToken() {
        ...
        if (!name || !symbol || !uri || !supply || isNaN(supply) || supply <= 0) {
            alert("Please fill all fields with valid values (supply must be a positive number)");
            return;
        }
    ...
    return (
        <div style={{
            ...
            <br />
            <input id="uri" className='inputText' type='text' placeholder='Image URL' />
            <br />
            <input id="supply" className='inputText' type='number' placeholder='Initial Supply' />
            <br />
